...
This directory contains `claude-plugins.zip` — the Blue Contact plugin bundle for Cowork, the Claude desktop app. This guide shows Claude Teams **account owners** how to install it for themselves and push it to every member of the team so it's available by default in Cowork.
...
- You have the `claude-plugins.zip` file in this directory
...
2. Go to **Cowork → Customize → Plugins**.
3. Click the **+** button and choose **Upload plugin**.
4. Select `claude-plugins.zip` from this directory.
5. Confirm the install. The `blue-contact` plugin should appear in your installed list.
6. Start a new Cowork session and run `/blue-contact:getting-started` to confirm it loads.
...
3. Click **Add plugin** and upload `claude-plugins.zip`.
